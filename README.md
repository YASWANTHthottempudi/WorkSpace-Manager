...
### **WEEK 1 – Frontend Foundation (UI + State + Mock Data)**
**Goal**: Build full UI flow before any backend connection.
...
| 5 | Page list sidebar | Nested structure like Notion (workspace → pages). Manage via Zustand/global context. |
